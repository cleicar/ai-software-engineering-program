...
This is a DuckHunt clone built with JavaScript and HTML5 to explore AI-driven gameplay. By leveraging neural networks, the game features an automated player capable of achieving perfect scores. It uses the PixiJS rendering engine, Green Sock Animations, Howler, and Bluebird Promises.
